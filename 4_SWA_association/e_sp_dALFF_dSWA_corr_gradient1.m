...
cd(outpath)
%%% beta
betafile1 = ['all_ALFF-v6_Sleep-Wake_all_SWAol_SW_all_beta_top5.nii.gz'];
...
% from spin model
txt={'{\it{r}} = -0.57','{\it{P}} < 0.0001'}; % use r from v6 data
t=text(3.0,0.07,txt,'left');
...
print(gcf,'-dpdf','-r400')
oldname=['figure1.pdf'];
newname=['dALFF_dSWAol_corr_gradient1_Margulies_v6_100prctiles.pdf'];
