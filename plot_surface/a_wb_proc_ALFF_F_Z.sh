...
#for data in ALFF-ctx-z-main-N2361-correctp05 ALFF-ctx-z-main-N2361 ; do
#for data in ALFF-ctx-z-main-N2361-R2 ; do
for data in ALFF-ctx-z-main-N2361-R2-correctp05 ; do
...
for data in meanmap_N1-W-N2361 meanmap_N2-W-N2361 meanmap_N3-W-N2361 meanmap_REM-W-N2361 meanmap_Sleep-W-N2361 ; do
# map volume to surface
wb_command -volume-to-surface-mapping ../${data}.nii.gz Conte69.L.midthickness.32k_fs_LR.surf.gii ./${data}.Conte69.l.func.gii -enclosing
...
for data in meanmap_N1-W-N2361-correctp05 meanmap_N2-W-N2361-correctp05 meanmap_N3-W-N2361-correctp05 meanmap_REM-W-N2361-correctp05 meanmap_Sleep-W-N2361-correctp05 ; do
# map volume to surface
wb_command -volume-to-surface-mapping ../${data}.nii.gz Conte69.L.midthickness.32k_fs_LR.surf.gii ./${data}.Conte69.l.func.gii -enclosing
...
for data in W_ALFF-ctx-z_mean-N2361 N1_ALFF-ctx-z_mean-N2361 N2_ALFF-ctx-z_mean-N2361 N3_ALFF-ctx-z_mean-N2361 REM_ALFF-ctx-z_mean-N2361 ; do
# map volume to surface
wb_command -volume-to-surface-mapping ../${data}.nii.gz Conte69.L.midthickness.32k_fs_LR.surf.gii ./${data}.Conte69.l.func.gii -enclosing
